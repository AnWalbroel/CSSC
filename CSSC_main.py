...
path_halo_dropsonde = "/net/sever/walbroel/CSSC_test/sonde_qc_interpolated_v01/"
path_BAH_data = "/data/hamp/flights/EUREC4A/unified/"	# BAHAMAS data path; OPTIONAL
print("Running dropsonde_raw_gap_filler.py ..........\n")
run_dropsonde_raw_gap_filler(path_raw_sondes, path_halo_dropsonde)
...
path_pam_ds = "/net/sever/walbroel/CSSC_test/pam_out/"  # output path of pamtra
