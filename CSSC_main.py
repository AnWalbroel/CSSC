...
path_pam_ds = "/net/sever/walbroel/CSSC_test/pam_out_BAH_J/"  # output path of pamtra
...
out_path = "/net/sever/walbroel/CSSC_test/sonde_comparison_half_raw_BAH_J/"
plot_path = "/net/sever/walbroel/CSSC_test/plots/TB_stat_BAH_J/"
