...
path_joanne3_sondes = "/data/hamp/flights/EUREC4A/JOANNE/EUREC4A_JOANNE_Dropsonde-RD41_Level_3_v0.9.2"
dropsonde_dataset = "joanne_level_3"
path_halo_dropsonde = "/net/gharra/mjacob/CSSC_test/sonde_JOANNE_interpolated_v0.9.2/" # output dir
...
path_sst = "/net/gharra/mjacob/CSSC_test/sst_slice/" # SST data path (data is downloaded here)
lat_bound = [0, 40]
lon_bound = [-70, 0]
...
path_pam_ds = "/net/gharra/mjacob/CSSC_test/pam_out_sonde_JOANNE_interpolated_v0.9.2/"  # output path of pamtra
...
for date in dates:
	...
	path_pam_ds = f"/net/gharra/mjacob/CSSC_test/pam_out_sonde_JOANNE_interpolated_v0.9.2/pamtra_*{date}"
